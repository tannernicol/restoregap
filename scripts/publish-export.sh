...
echo "  4. Publishing is gated on the allowlist in ~/CLAUDE.md ('restoregap' added 2026-08-12)."
echo "     Public content comes ONLY from this export — never flip visibility on the working repo."
